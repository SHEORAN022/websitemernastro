...
// // //       })
// // //       .catch((err) => console.log("Clients fetch error:", err));
// // //   }, []);
...
// // //       {/* Toggle button */}
// // //       {!sidebarOpen && (
// // //         <button className="sidebar-toggle-home" onClick={() => setSidebarOpen(true)}>
// // //           ☰
// // //         </button>
// // //       )}
...
// // //                 <input name="tob" placeholder="Time of Birth (HH:MM)" value={formData.tob} onChange={handleChange} />

// // //                 <input name="pob" placeholder="Place of Birth" value={formData.pob} onChange={handleChange} />

// // //                 <input name="occupation" placeholder="Current Occupation" value={formData.occupation} onChange={handleChange} />

// // //                 <textarea name="keyConcerns" placeholder="Key Concerns (Optional)" rows={4} value={formData.keyConcerns} onChange={handleChange} />
...
// // //                   <img src={client.image} className="client-img" alt={client.name} />
// // //                   <h4>{client.name}</h4>
// // //                   <p>{client.description}</p>
// // //                 </div>
// // //               ))
