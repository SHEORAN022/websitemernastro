...
//     const options = {
//       key: process.env.REACT_APP_RAZORPAY_KEY_ID,  // KEY FIXED
//       amount: order.amount,
//       currency: "INR",
//       name: "THE FIFTH CUSP",
//       description: selectedService.label,
...
//           ...response,
//           amount,
//           userId: "672af93b9cf24a87a0c5f8de",
//           planId: selectedService.id,
//         });
...
const Vastu = () => {
  ...
  // ✅ userId: login se lo, warna test user (admin jaisa)
  const storedUser = JSON.parse(localStorage.getItem("user"));
  const userId = storedUser?._id || "672af93b9cf24a87a0c5f8de";
  ...
  try {
    ...
    const orderRes = await axios.post(
      "https://adminastrotalk-1.onrender.com/api/payments/create-order",
      {
      ...
      handler: async function (response) {
        try {
          const verifyRes = await axios.post(
            "https://adminastrotalk-1.onrender.com/api/payments/verify",
            {
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <section className="hero-section">
              <div className="hero-container">
                <div className="hero-content">
                  <div className="hero-badge">Authentic Vastu Consultancy</div>
                  <h1 className="hero-title">Transform Your Space with Vastu Shastra</h1>
                  <p className="hero-description">
                    Harmonize your home or workplace with ancient Vastu wisdom.
                  </p>
