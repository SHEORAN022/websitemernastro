...
//     content: "Full content of the blog 1 goes here...",
//   },
//   {
//     id: 2,
...
//     date: "Sep 15, 2025",
//     author: "Rinku Sheoran",
//     content: "Full content of the blog 2 goes here...",
//   },
//   {
//     id: 3,
...
//     date: "Aug 10, 2025",
//     author: "Rinku Sheoran",
//     content: "Full content of the blog 3 goes here...",
//   },
// ];
...
//     if (starfield.childElementCount === 0) {
//       for (let i = 0; i < 120; i++) {
...
//   return (
//     <div className="blog-page cosmic-bg">
...
//       {/* 📝 Main Blog Content */}
//       <div className={`blog-content ${sidebarOpen ? "shifted" : ""}`}>
...
//         <div className="blog-grid">
//           {blogs.map((blog) => (
//             <BlogCard key={blog.id} {...blog} ctaText="Read More" onClick={() => handleReadMore(blog)} />
//           ))}
//         </div>
//       </div>
//     </div>
